            ...
            <nav className="flex justify-between items-center" id='navbar'>
                ...
                <div>
                    <ul className='flex space-x-10 items-center'>
                        {navLinks.map(item => (
                            <li className={`font-alex text-gray-500 hover:cursor-pointer ${active === item ? 'text-white' : ''}`} onClick={() => {handleClick(item)}}>{item}</li>
                        ))}
                    </ul>
                </div>
                <div className='flex space-x-5 items-center'>
            ...
            <section className="flex-col flex lg:flex-row justify-between flex-1 items-center" id='hero'>
                <div className='flex-2 w-full flex space-y-10 flex-col'>
                    <div className='flex flex-col space-y-6'>
                        <div className='border py-2.5 px-3 rounded-3xl flex items-center space-x-2 w-fit'>
                            <div className='rounded-full h-2 w-2 bg-green'></div>
                            <p className='text-green text-sm'>Decentralized</p>
                        </div>
                        <h1 className='lg:w-[661px]'>Revolutionizing<br/> Web3 Finance</h1>
                        <p className='text-start font-inter text-[20px] font-light text-[#999999] w-[583px]'>
                    ...
                    <div className='flex space-x-5 w-fit'>
                        ...
                        <button className='py-3.5 px-6 bg-transparent border border-white text-white flex'>
