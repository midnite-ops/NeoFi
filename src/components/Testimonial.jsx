...
function Testimonial(){
    const names = ['Eleanor Pena', 'Jerome Bell', 'Darell Steward', 'Bessie Copper', 'Kathryn Murphy', 'Guy Hawkins']
    const row1 = []
    const row2 = []
    function generateRows(value, num){
        for(let i = 0; i < names.length; i++){
            ...
            if(i === num){
                ...
                value.push(
                    <div key={i} className='border border-grayBorder rounded-[20px] p-8 space-y-8 w-[373px]'>
    ...
    return(
        <section id="testimonial" className="box bg-gray -mx-[114px] overflow-hidden relative">
            ...
            <div className="pointer-events-none absolute left-0 bottom-10 h-[452px] w-35 bg-gradient-to-r from-black/60 to-transparent z-10"></div>
            <div className="pointer-events-none absolute right-0 bottom-10 h-[452px] w-35 bg-gradient-to-l from-black/60 to-transparent z-10"></div>
